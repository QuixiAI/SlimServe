...
| 5 | Main conflicts resolved and merged profile qualified. Published review stack #26 -> #27 -> #28 -> #25 -> #24; substantive review, feedback fixes and cleanup remain open. Foundry is explicitly out of scope; disabled-tier qualification and external port-back are follow-ups, not publication gates. |
