...
def loader_source_files():
    # Torch also exports standalone_compile as a function on its package.
    # Resolve module objects explicitly, not dotted-import package attributes.
    names = (
