...
#
# Vendored verbatim from the released Kimi K3 model repo. Imported by the
# vendored `kimi_k3` tokenizer to turn a message list into the segments its
# chat format expects; carried as-is for the same reason as the tokenizer.
