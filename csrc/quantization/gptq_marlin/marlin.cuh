...
static constexpr int default_threads = kDefaultThreads;

static constexpr int pipe_stages =
    kPipeStages;  // 4 pipeline stages fit into shared memory

static constexpr int min_thread_n = kMinThreadN;
static constexpr int min_thread_k = kMinThreadK;
static constexpr int max_thread_n = kMaxThreadN;

static constexpr int tile_size = kTileSize;
static constexpr int max_par = kMaxPar;

// Repack params
static constexpr int repack_stages = kRepackStages;

static constexpr int repack_threads = kRepackThreads;

static constexpr int tile_k_size = kTileKSize;
static constexpr int tile_n_size = kTileNSize;
