#!/bin/bash
# Benchmark a model via vllm serve + curl (with CUDA graphs)
set -e
...
echo ""
echo "============================================================"
echo "Benchmarking: $LABEL (CUDA graphs)"
echo "Model: $MODEL"
echo "============================================================"

# Start server in background (NO enforce-eager = CUDA graphs enabled)
